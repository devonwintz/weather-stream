...
create_table() {
    create_table_command="CREATE TABLE IF NOT EXISTS $CASSANDRA_KEYSPACE.$CASSANDRA_TABLE (
        ...
        cloud_cover DOUBLE,
        wind_direction TEXT,
        wind_speed_metric DOUBLE,
        wind_speed_imperial DOUBLE,
        current_precipitation_metric DOUBLE,
        current_precipitation_imperial DOUBLE,
        current_temperature_metric DOUBLE,
        current_temperature_imperial DOUBLE,
        avg_humidity DOUBLE,
